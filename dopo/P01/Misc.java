...
public class Misc
{
	...
	/**
	 * Muestra un mensaje de error cuando se intenta mover un robot pero sin
	 * embargo no hay robot el cual mover
	 */
	...
	/**
	 * Muestra una ventana indicando el profit que se ha logrado el dia n,
	 * siendo n el dia actual
	 */
